            ...
            <div class="col">
              <div class="card rounded-3">
                ...
                <div class="card-body p-4 p-md-5" >
                  ...
                  <form class="px-md-2" name="add_det" id="add_det">
                    <div class="row">
                         ...
                         <div class="row">
                           ...
                           <div class="row">
                             <div class="col-md-4 mb-3">
                                 <div class="form-outline">
                                   <input type="number" name="sgpa2" class="form-control" id="sg2" required/>
                                   <label for="sg2" class="form-label">SGPA</label>
                                 </div>
                               </div>
                               <div class="col-md-4 mb-3">
                                 <div class="form-outline">
                                   <input type="number" name="cgpa2" class="form-control" id="cg2" required/>
...
if(isset($_POST['sub']) ){
      ...
      $query1= "INSERT INTO sem2(name,usn,sub1,mark1,sub2,mark2,sub3,mark3,sub4,mark4,sub5,mark5,sub6,mark6,cgpa,sgpa,bl) VALUES('$name','$usn','$sub11','$mark11','$sub21','$mark21','$sub31','$mark31','$sub41','$mark41','$sub51','$mark51','$sub61','$mark61','$cgpa1','$sgpa1','$bl1' )";
